...
3. ps -u dima (замість dima вписується логін користувача) — виводить процеси, які належать лише конкретному користувачу:

<img src = "9.png" width = "800">

4. ps -f — виводить повний формат списку (Full-format), що додає колонки з часом старту та назвою батьківського процесу (PPID):

<img src = "10.png" width = "800">

6. ps -axjf або ps --forest — виводить ієрархію процесів у вигляді "дерева", де наочно видно, який процес запустив інший:

<img src = "11.png" width = "800">

8. ps -p 123 (замість 123 впишу будь-який PID) — виводить інформацію про один конкретний процес за його ідентифікатором:
