...
| `echo [DP]*` <br> `echo [!DP]*` | Тут використовується пара квадратних дужок [ ], щоб вказати, який саме символ буде дозволено. Дозволені символи можуть бути вказані як діапазон, список або так званий клас символів. У першому прикладі перший символ 
імені файлу може бути D або P. У другому прикладі перший символ може бути будь-яким символом, крім D або P |
